<template>
  ...
  >
    <div class="logos-slide flex flex-col justify-center items-center">
      ...
      >
        <img
          src="../../assets/homepage/doctor.png"
          alt=""
      ...
      >
        <img
          src="../../assets/homepage/model 2.png"
          alt=""
          class="h-1/2 mx-0 w-full"
        />
      </div>
      ...
      >
        <img
          src="../../assets/homepage/model 1.png"
          alt=""
          class="h-1/2 mx-0 w-full"
        />
      </div>
      ...
      >
        <img
          src="../../assets/homepage/SLim_Sliding_Box_Packaging_Mockup_1 copy.png"
          alt=""
          class="h-1/2 mx-0 w-full"
        />
      </div>
...
<script>
import shimul from "../../assets/homepage/doctor.png";
export default {
  name: "",
  setup() {
    return {
